...
3. Red board LED: [Status LED Blinkcodes](https://jomjol.github.io/AI-on-the-edge-device-docs/StatusLED-BlinkCodes/)
4. Serial log of the UART interface (USB access needed, only local, same as for flashing the firmware)
